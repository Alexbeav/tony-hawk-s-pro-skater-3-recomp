# Tony Hawk's Pro Skater 3 feasibility binding

## Identity

- Title and region: Tony Hawk's Pro Skater 3, USA.
- Serial: SLUS-01419.
- Source executable path: `disc/SLUS_014.19`.
- Load address: `0x80010000`.
- Entry point: `0x800A480C`.
- Source disc binding: `disc/Tony Hawk's Pro Skater 3 (USA).cue`.
...
The clean source commit is `dc7613d32e5efb20b746ccd0248597232fac7f1c`. It uses PSXRecomp
`eecf3b2a4ee3148f01f8f92b512930fd6307d82e` and recomp-ui `87bbf43c419c16b97bf433a84d600969159e2e84`. The source
contains 1903 non-comment seed rows.
...
- Source `game.toml`, `catalog_identity.json`, `VERSION`, and Git submodule
  entries at `dc7613d32e5efb20b746ccd0248597232fac7f1c`.
- Portfolio `tony-hawk-s-pro-skater-3/BUILDINFO.json`.
- Portfolio `tony-hawk-s-pro-skater-3/RECEIPT.md`.
